...
import {
  LayoutDashboard, Car, Users, MapPin, CalendarOff, BarChart2,
  ClipboardList, History, Star, LogOut, Zap, Map, Truck, Plus,
} from 'lucide-react'
...
const NAV = {
  ...
  guest: [
    ...
    { to: '/guest/request',   icon: Plus,            label: 'Request Trip'   },
...
const roleColors = { admin:'bg-brand-500',  driver:'bg-emerald-500', guest:'bg-amber-500' }
